...
# lane.add_exits([Exit(["shop", "north east", "northeast", "ne"], "classrooms.shop", "There's a curiosity shop to the north-east.")])
...
# lane.add_exits([WizardTowerEntry("west", "hallways.hall", "To the west is the wizard's tower. It seems to be protected by a force-field.")])
...
# square.init_inventory([glasses_case, cursed_gem, normal_gem, paper, trashcan, pouch, insertonly_box, removeonly_box, clock, towncrier, idiot, rat, ant])
