...
def render_page(page, filename):
    ...
    # removed the beginning four spaces.  I need to keep a copy
    # of the exact lengths, so I can always add the same amount
    # for each indentation, so I just created a new class attribute
    # which is a string with four spaces.
    page.render(f, "")
...
page.append("Here is a paragraph of text -- there could be more of them, but "
            "this is enough  to show that we can do some text")

page.append("And here is another piece of text -- you should be able to add "
            "any number")
...
body.append(hr.P("And here is another piece of text -- you should be able to "
                 "add any number"))
