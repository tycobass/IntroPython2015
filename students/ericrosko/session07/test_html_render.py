...
# import regular expressions so I can strip spaces and \n's from text
import re
...
def test_paragraph_with_style_string():
    ...
    body.append(hr.P("Here is a paragraph of text -- there could be more of "
...
def test_li():
    ...
    body = hr.Body()
    li = hr.Li()
    li.append(hr.A("http://google.com", "link"))
    body.append(li)
    html.append(body)
